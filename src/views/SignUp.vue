<template>
    <div>
      <div> 
        ...
        <div id="signUpForm">
            ...
            <p>
              <input name="uid" class="w3-input" placeholder="Enter your ID" v-model="userid"><br>
            </p>
            <p>
            ...
            <p>
              <input name="password" class="w3-input" placeholder="confirm password" v-model="password2" type="password" @blur="checkDuplicate">
            </p>
            <p>
  ...
  export default {
    ...
    async checkEmail() {
        ...
        // 이메일 중복체크
        const response = await signUpService.checkDuplicateEmail(this.email);
        if(!response.data) {
